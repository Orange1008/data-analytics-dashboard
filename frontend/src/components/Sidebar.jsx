...
const Sidebar = () => {
    ...
    return (
        <aside className="w-64 bg-[#181c25] h-screen border-r border-[#262A36] flex flex-col text-sm text-gray-400 font-medium z-30 fixed lg:relative">
            {/* Header / Logo */}
            <div className="h-16 flex items-center px-6 border-b border-[#262A36]">
